...
const VideoMaskTransition = () => {
    ...
    // Auto-reveal on mobile/scroll
    const videoScrollOpacity = useTransform(scrollYProgress, [0.2, 0.4, 0.8, 0.95], [0, 1, 1, 0]);
            ...
            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
                    <motion.div 
                        ...
                        className="pointer-events-auto relative z-10 w-32 h-32 md:w-48 md:h-48 border-[300px] md:border-[500px] border-black rounded-full shadow-[0_0_150px_rgba(0,0,0,1)] cursor-none box-content"
                    >
                        {/* Inner Lens Area */}
                        <div className="w-full h-full rounded-full overflow-hidden relative group bg-black">
                             {/* The actual "Video Eye" */}
                            <motion.div
                                style={{ opacity: isHovering ? 1 : videoScrollOpacity }}
                                className="absolute inset-0 z-50 overflow-hidden rounded-full"
                            >
                                <video 
                                    autoPlay 
                                    loop 
                            ...
                            <div className="absolute inset-0 pointer-events-none z-[60] opacity-20 bg-gradient-to-tr from-transparent via-white/5 to-transparent"></div>
                        </div>
                    </motion.div>
                </div>
                ...
                <motion.div 
                    style={{ opacity }}
                    className="absolute z-20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center px-6 pointer-events-none"
                >
                ...
                <motion.div
                    ...
                    className="absolute bottom-24 left-1/2 -translate-x-1/2 z-40 text-center pointer-events-none"
                >
