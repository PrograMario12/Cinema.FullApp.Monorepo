        ...
        <section id="request-screening" className="py-32 px-6 md:px-12 bg-[#14171C]">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    <span className="text-[10px] uppercase tracking-[0.4em] text-gray-500 font-bold block mb-4">Collaboration</span>
                    <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter text-white">Request a Screening</h2>
                </div>

                <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-6">
                        <div className="group border-b border-white/10 focus-within:border-white transition-colors py-2">
                            <label className="text-[10px] uppercase font-bold text-gray-500 mb-1 block">Organization</label>
                            <input 
                                type="text" 
                                name="organization"
                        ...
                        <div className="group border-b border-white/10 focus-within:border-white transition-colors py-2">
                            <label className="text-[10px] uppercase font-bold text-gray-500 mb-1 block">Audience Type</label>
                            <select 
                                name="audienceType"
                            ...
                            >
                                ...
                                <option value="community" className="bg-black">Local Community</option>
                    ...
                    <div className="space-y-6">
                        <div className="group border-b border-white/10 focus-within:border-white transition-colors py-2">
                            <label className="text-[10px] uppercase font-bold text-gray-500 mb-1 block">Proposed Date</label>
                            <input 
                                type="date" 
                                name="proposedDate"
                    ...
                    <div className="md:col-span-2 group border-b border-white/10 focus-within:border-white transition-colors py-2">
                        <label className="text-[10px] uppercase font-bold text-gray-500 mb-1 block">Message / Additional Details</label>
                        <textarea 
                            name="message"
